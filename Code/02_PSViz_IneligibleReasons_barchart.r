...
#setwd("/Users/tg625/Documents/PDA/Directory/LC_REPORT")
...
pie_Ineligibility <- dat %>%
            ...
            mutate(eligibility=recode(eligibility, 
...
plot<-df_odered %>%
  ...
  gg2_bar <- plot + geom_text(aes(label = bar_text),
...
#ggsave(gg3_bar, filename = "/Users/tg625/Documents/PDA/Directory/LC_REPORT/Figures/reasonsForExlusion_barchart.pdf")
